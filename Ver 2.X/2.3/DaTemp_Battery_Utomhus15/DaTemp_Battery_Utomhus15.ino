...
//Fixed ID/Parent?
#define MY_NODE_ID 15                     //To set a fixed ID for your node
...
#define SKETCH_NAME "Utomhus Syd #15"        // Change to a fancy name you like
...
#define VMIN 2.7                                  //  Vmin (radio Min Volt)=1.9V (564v)
